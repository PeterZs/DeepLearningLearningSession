...
im = Image.open('/home/chenliu/Projects/DeepLearningToyExamples/DayAndNight/Data/day/1.jpg')
...
# load net
net = caffe.Net('/home/chenliu/Projects/DeepLearningToyExamples/DayAndNight/Models/day_to_night_deploy.prototxt', '/home/chenliu/Projects/DeepLearningToyExamples/DayAndNight/Models/day_to_night_iter_10000.caffemodel', caffe.TEST)
...
print label.shape
#label_image = Image.fromarray(np.int32(label * 255))
label_image = scipy.misc.toimage(np.int32(label * 255))
